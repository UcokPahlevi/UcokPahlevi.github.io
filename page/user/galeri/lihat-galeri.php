...
<head>
    ...
    <title>XI PPLG A - Lihat Galeri</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-4bw+/aepP/YC94hEpVNVgiZdgIC5+VKNBQNGCHeKRQN+PtmoHDEXuppvnDJzQIu9" crossorigin="anonymous">
    <link rel="stylesheet" href="/kelas/css/user/galeri/lihat-galeri.css">
</head>
...
<nav class="navbar navbar-expand-lg fixed-top">
    ...
    <div class="proses">
        <div class="pro-title-area text-center">
            <p class="pro-title">GALERI - XI PPLG A</p>
        </div>
            ...
            <div class="col-lg-5 pro-set-area">
                <div class="row pro-set-up-area justify-content-center">
                    <div class="col-lg-12 text-center">
                        ...
                        <p class="pro-set-title"><?php echo $bagian["keterangan"]; ?></p>
                        <p class="pro-set-sub-title">FOTO DIAMBIL PADA : <?php echo $bagian["tanggal"]; ?></p>
                    </div>
                </div>
            </div>
        </div>
