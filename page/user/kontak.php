...
<head>
    ...
    <link rel="stylesheet" href="/kelas/css/user/kontaks.css">
</head>
...
<?php
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item dropdown drop-2">
                            <a class="nav-link-drop dropdown-toggle" href="#" role="button"
                        ...
                        <li class="nav-item">
                            <a class="nav-link aktif" aria-current="page" href="/kelas/page/user/kontak.php"><img
    ...
    <div class="kontak">
        <div class="kt-title-area d-flex justify-content-center">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <p class="kt-open-text">Punya pertanyaan tidak penting yang ingin di tanyakan? atau saran,
                            keluhan dan yang lainya tentang XI PPLG. Anda bisa hubungi admin kami disini :</p>
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <a class="kt-sosmed-text d-flex justify-content-center" href="#">
                                    <img class="img-fluid kt-icon" src="/kelas/assets/icon/sosial-media/waa.png" alt="">
                                    <p class="kt-text-link">0895 - 3128 - 3960 ( Ucok )</p>
                                </a>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <a class="kt-sosmed-text d-flex justify-content-center" href="#">
                                    <img class="img-fluid kt-icon" src="/kelas/assets/icon/sosial-media/gmail.png"
                                        alt="">
                                    <p class="kt-text-link">xipplga@gmail.com ( Rifky )</p>
                                </a>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <a class="kt-sosmed-text d-flex justify-content-center" href="#">
                                    <img class="img-fluid kt-icon" src="/kelas/assets/icon/sosial-media/instagram.png"
                                        alt="">
                                    <p class="kt-text-link">@xi.pplg.a ( Syalwa & Rizal )</p>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-10">
                            <form class="kt-form" action="../../proses/user/kontak.php" method="post">
                            <div>
                                <p class="kt-form-label">NAMA :</p>
                                <p class="kt-form-info">Tidak di haruskan menggunakan nama asli</p>
                                <input class="form-control" type="text" name="nama">
                            </div>
                            <div class="kt-form-row">
                                <p class="kt-form-label">KATEGORI :</p>
                                <p class="kt-form-info">Pilih kategori yang sesuai</p>
                            ...
                            <div class="kt-form-row">
                                <p class="kt-form-label">PESAN :</p>
                                <textarea class="form-control" type="text" rows="5" name="pesan"></textarea>
                            </div>
                            <div class="kt-btn-area text-center">
                                <button class="kt-btn" type="submit">KIRIM</button>
                            </div>
                        </form>
                            </div>
                        </div>
