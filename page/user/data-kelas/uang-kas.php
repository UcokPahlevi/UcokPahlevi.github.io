...
<head>
    ...
    <link rel="stylesheet" href="/kelas/css/user/data-kelas/uang-kas.css">
</head>
...
<body>
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item dropdown drop-2">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="drop-item-aktif" href="/kelas/page/user/data-kelas/uang-kas.php">Uang Kas</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
    ...
    <div class="uang-kas">
        <div class="uk-title-area d-flex justify-content-center">
            <p class="uk-title">UANG KAS</p>
        </div>
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <form class="d-flex" action="" method="post">
                    <input class="form-control me-2" type="text" placeholder="Cari berdasarkan nama" autocomplete="off" name="keyword">
