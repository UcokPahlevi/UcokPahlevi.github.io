...
<head>
    ...
    <link rel="stylesheet" href="/kelas/css/user/data-kelas/jadwal-piket.css">
</head>
...
<body><nav class="navbar navbar-expand-lg fixed-top">
                        ...
                        <li class="nav-item dropdown drop-2">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="drop-item-aktif"
                                        href="/kelas/page/user/data-kelas/jadwal-piket.php">Jadwal
                                        piket</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
    ...
    <div class="jadwal-piket">
        <div class="jp-title-area d-flex justify-content-center">
