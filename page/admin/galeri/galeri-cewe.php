...
<head>
    ...
    <link rel="stylesheet" href="/kelas/css/admin/galeri.css">
</head>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link aktif" aria-current="page" href="/kelas/page/admin/galeri.php"><img
                ...
                <div class="row text-center justify-content-center">
                    <div class="col-lg-3">
                        <div class="gl-flt-btn-area">
                            <a href="/kelas/page/admin/galeri.php" class="gl-flt-btn">SEMUA</a>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="gl-flt-btn-area">
                            <a href="/kelas/page/admin/galeri/galeri-cowo.php" class="gl-flt-btn">COWO</a>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="gl-flt-btn-area">
                            <a href="/kelas/page/admin/galeri/galeri-cewe.php" class="gl-flt-btn btn-aktif">CEWE</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-11">
                <div class="gk-area text-center">
                    <div class="gk-plus">
                        <a class="gk-plus-btn" href="/kelas/page/admin/pengaturan/tambah-galeri-cewe.php">+ TAMBAHKAN FOTO</a>
                    </div>
                <div class="row">
                        <?php
                        include '../../../koneksi.php';
                        $tabelQuery = "SELECT * FROM galeri WHERE kategori = 'cewe'";
                        ...
                        while ($bagian = mysqli_fetch_assoc($result)) { ?>
                            <div class="gk-img-area col-lg-2">
                                <div>
                                    ...
                                    <div class="gk-img-set">
                                        <a class="gk-set-edit" href="/kelas/page/admin/pengaturan/edit-galeri-cewe.php?id=<?php echo $bagian['id']; ?>">
                                            <img class="gk-set-icon" src="/kelas/assets/icon/button/edit.png" alt="">
                                        </a>
                                        <a class="gk-set-hapus" href="/kelas/proses/admin/hapus-galeri-cewe.php?id=<?php echo $bagian['id']; ?>"
                                        onclick="return confirm('Yakin mau dihapus?')">
                                            <img class="gk-set-icon" src="/kelas/assets/icon/button/hapus.png" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
