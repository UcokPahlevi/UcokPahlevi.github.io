        ...
        <div class="row justify-content-center">
            ...
            function upload()
            {
                ...
                if ($error === 4) {
                    ...
                    header("Location: /kelas/page/pengaturan/edit-galeri-cewe.php");
                    return false;
                }
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($koneksi->query($sql_update) === TRUE) {
                    ...
                    echo "Error: Data tiderhasil dipeak brbarui";
                }
            }
            ?>
                ...
                <div class="row justify-content-center">
                    <div class="pro-set-right col-lg-8 mt-5">
                        ...
                        <div class="pro-set-konfirm d-flex justify-content-center">
                            ...
                            <a class="pro-set-konfirm-batal" href="/kelas/page/admin/galeri/galeri-cewe.php" onclick="return confirm('Ga jadi di ubah nih?')">Batal</a>
                        </div>
                    </div>
                </div>
            </form>
