...
<body>
    ...
    <div class="proses">
        ...
        <div class="row justify-content-center">
            <form action="../../../proses/admin/tambah-galeri-cowo.php" method="post" class="col-lg-6 pro-edit-area"
                ...
                <div class="pro-set-right col-lg-8">
                    ...
                    <input type="hidden" class="form-control" name="kategori" id="kategori"
                            autocomplete="off" value="cowo" required>
                    <?php
                    ...
                    <div class="pro-set-konfirm d-flex justify-content-center">
                        ...
                        <a class="pro-set-konfirm-batal" href="/kelas/page/admin/galeri/galeri-cowo.php" onclick="return confirm('Ga jadi ditambah nih?')">Batal</a>
                    </div>
                </div>
                </div>
            </form>
