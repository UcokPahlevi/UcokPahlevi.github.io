...
<body>
    ...
    <div class="proses">
        ...
        if (isset($_GET['id'])) {
            ...
            INNER JOIN data_siswa ON struktur_kelas.nis_nik = data_siswa.nis
            WHERE id = $id";
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $newNis = $_POST['nis_nik'];

            $sql_update = "UPDATE struktur_kelas SET
            nis_nik = '$newNis' WHERE id = $id";
                ...
                <form action="" method="post">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <img class="img-fluid rounded"
                                    src="/kelas/assets/images/foto-guru/<?php echo $bagian["foto"] ?>" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pro-form-area">
                        <select class="form-select" name="nis_nik">
                            <option class="form-select" selected value="<?php echo $bagian["nis"]; ?>">
                            ...
                            while ($bagian2 = mysqli_fetch_assoc($result)) {
                                ?>
                                <option class="form-option" value="<?php echo $bagian2["nis"]; ?>">
                                    <?php echo $bagian2["nama"]; ?>
                                </option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="pro-set-konfirm d-flex justify-content-center">
                        ...
                        <a class="pro-set-konfirm-batal"
                            href="/kelas/page/admin/data-kelas/struktur-kelas.php" onclick="return confirm('Ga jadi di ubah nih?')">Batal</a>
                    </div>
                </form>
            </div>
        </div>
