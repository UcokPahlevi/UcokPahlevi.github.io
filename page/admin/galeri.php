                ...
                <div class="row text-center justify-content-center">
                    <div class="col-lg-3">
                        <div class="gl-flt-btn-area">
                            <a href="/kelas/page/admin/galeri.php" class="gl-flt-btn btn-aktif">SEMUA</a>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="gl-flt-btn-area">
                    ...
                    <div class="col-lg-3">
                        <div class="gl-flt-btn-area">
                            <a href="/kelas/page/admin/galeri/galeri-cewe.php" class="gl-flt-btn">CEWE</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-11">
                <div class="gk-area text-center">
                    <div class="gk-plus">
                        <a class="gk-plus-btn" href="/kelas/page/admin/pengaturan/tambah-galeri.php">+ TAMBAHKAN
                            FOTO</a>
                    </div>
                    <div class="row">
                        <?php
                        include '../../koneksi.php';
                        $tabelQuery = "SELECT * FROM galeri WHERE kategori = 'semua'";
                            ...
                            <div class="gk-img-area col-lg-2">
                                <div>
                                    ...
                                    <div class="gk-img-set">
                                        <a class="gk-set-edit"
                                            href="/kelas/page/admin/pengaturan/edit-galeri.php?id=<?php echo $bagian['id']; ?>">
                                            <img class="gk-set-icon" src="/kelas/assets/icon/button/edit.png" alt="">
                                        </a>
                                        <a class="gk-set-hapus"
                                            href="/kelas/proses/admin/hapus-galeri.php?id=<?php echo $bagian['id']; ?>"
