...
$Bs = query("SELECT * FROM data_siswa");

if (isset($_POST["cari"])) {
    $Bs = cariBs($_POST["keyword"]);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="stylesheet" href="/kelas/css/admin/data-kelas/biodata-siswa.css">
</head>
...
<body>
                        ...
                        <li class="nav-item dropdown drop-2">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="drop-item-aktif"
                                        href="/kelas/page/admin/data-kelas/biodata-siswa.php">Biodata
                                        Siswa</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
    ...
    <div class="biodata-siswa">
        <div class="bs-title-area text-center">
            <p class="bs-title">BIODATA SISWA</p>
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <p class="bs-sub-title">Hanya dapat mengubah data, tidak dapat menambah / menghapus.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <form class="d-flex" action="" method="post">
                    ...
                    <button class="bs-btn-src" type="submit" name="cari"><img class="bs-src-icon"
        ...
        <?php
                ...
                <div class="bs-card col-3">
                    <div class="bs-aja row" href="">
                        ...
                        <hr class="bs-set-line">
                        <div class="bs-set-area text-center">
                            <a class="bs-set-edit" href="/kelas/page/admin/pengaturan/edit-biodata-siswa.php?id=<?= $row["nis"]; ?>">UBAH BIODATA SISWA</a>
                        </div>
                    </div>
                </div>
                        <?php endforeach ?>
