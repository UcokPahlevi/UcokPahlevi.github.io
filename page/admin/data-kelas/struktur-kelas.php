...
<head>
    ...
    <link rel="stylesheet" href="/kelas/css/admin/data-kelas/struktur-kelas9.css">
</head>
...
<body>
    ...
    <div class="struktur-kelas">
        <div class="sk-title-area text-center">
            <p class="sk-title">STRUKTUR KELAS</p>
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <p class="sk-sub-title">Hanya dapat mengubah data, tidak dapat menambah / menghapus.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row sk-row-area-2 justify-content-center text-center">
            ...
            while ($bagian = mysqli_fetch_assoc($result)) { ?>
                <div class="col-lg-3 sk-card-area-2">
                    <p class="sk-card-info">
                        <?php echo $bagian["keterangan"] ?>
                    </p>
                    <img class="img-fluid rounded" src="/kelas/assets/images/foto-guru/<?php echo $bagian["foto_guru"] ?>" alt="">
                    ...
                    <hr class="sk-card-line text-center">
                    <div class="sk-set-area">
                        <a class="sk-set-edit-pro"
                            href="/kelas/page/admin/pengaturan/edit-struktur-kelas-guru.php?id=<?= $bagian["id"]; ?>">
                        UBAH WALI KELAS
                        </a>
                    </div>
                </div>
        ...
        <div class="row sk-row-area-2 justify-content-center text-center">
            ...
            while ($bagian = mysqli_fetch_assoc($result)) { ?>
                <div class="col-lg-2 sk-card-area-2">
                    ...
                    <div class="sk-set-area">
                        <a class="sk-set-edit-pro"
                            href="/kelas/page/admin/pengaturan/edit-struktur-kelas-siswa.php?id=<?= $bagian["id"]; ?>">
                            UBAH SISWA
                        </a>
                    </div>
                </div>
