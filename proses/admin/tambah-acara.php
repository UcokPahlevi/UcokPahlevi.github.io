...
function upload()
{
    ...
    if ($error === 4) {
        ...
        header("Location: /kelas/page/admin/pengaturan/tambah-acara.php");
        return false;
    }
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $uploadQuery = "INSERT INTO acara (url, judul, deskripsi ) VALUES ('$gambar', '$judul', '$deskripsi')";
}

if ($koneksi->query($uploadQuery) === TRUE) {
    $_SESSION['alert-tambah-acara'] = "";
